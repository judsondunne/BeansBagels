  ...
  return (
    <View style={styles.container}>
      ...
      <ImageBackground
        ...
        source={{
          uri:
            'https://eatwheat.org/wp-content/uploads/2020/11/web-1200x750.png',
        }}
      ...
      <ScrollView contentContainerStyle={styles.contentContainer}>
        {/* Title */}
        <Text style={styles.title}>Sausage Egg and Cheese</Text>
        ...
        Juicy sausage patty, egg, and melted cheese on a fresh, toasted bagel.
        </Text>
